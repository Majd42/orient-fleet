    ...
    <div id='beOneOfUs' >
        <div className="one-img-container">
            <div className="one-img-content">
                ...
                <Typography style={styles} color='white' variant='h3' letterSpacing={TextDynamicSpacing}>{t('beOneOfUsTitle')}</Typography>
                <Typography style={styles} 
                varinat='body1' color='white' letterSpacing={TextDynamicSpacing}>{t('beOneOfUsText')}
                </Typography>
            </div>
        </div>
        ...
        <div className="scroll-top">
          ...
          <a href='#beOneOfUs' className='back-to-top'>
